...
const pluginInfo_t* IPluginInfo::Lookup(
	const pluginInfoString_t& a_modName) const
{
...
const pluginInfo_t* IPluginInfo::Lookup(
	std::uint32_t const a_modID) const
{
...
bool IPluginInfo::ResolveFormID(
